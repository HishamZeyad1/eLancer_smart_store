...
class _FavoriteWidgetState extends State<FavoriteWidget> with Helpers {
  ...
  void ss()async{
    await FavoriteGetxController.to.readFavorite();
  }
  @override
  Widget build(BuildContext context) {
    ...
    return Obx(
        (){
      // builder: (controller) {
        if (FavoriteGetxController.to.loading.value) {
          return const Center(child: CircularProgressIndicator());
        }
        else if (FavoriteGetxController.to.favorite.isNotEmpty) {
          // print("length: ${controller.favorite.length}");
          return ListView.builder(
              itemCount: FavoriteGetxController.to.favorite.length,
              shrinkWrap: true,
                      ...
                      children: [
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                                image: NetworkImage(
                                  ...
                                  FavoriteGetxController.to.favorite[index].product.imageUrl,
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  ...
                                  lang=='en'?FavoriteGetxController.to.favorite[index].product.nameEn:FavoriteGetxController.to.favorite[index].product.nameAr,
                        ...
                        IconButton(
                            onPressed: () => changeFavorite(
                                FavoriteGetxController.to.favorite[index].product),
                            icon: Icon(
                  ...
                  onTap: () => Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => ProductDetailsScreen(
                            FavoriteGetxController.to.favorite[index].product.id),
                      )),
                );
              });
        }
